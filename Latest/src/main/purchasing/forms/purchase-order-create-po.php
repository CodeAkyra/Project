...
<head>
    ...
    <title>Purchase Order Create PO</title>
</head>
...
<body class="body-iframe-padding">
    ...
    <div class="header">
        ...
        <div class="button-container">
            ...
            <button class="btn-create" id="createPO" onclick="alert('Create Purchase Order Successfully!'); parent.postMessage('purchasing-saveCreatePO','*');">Save and
                Confirm</button>
        </div>
    </div>
