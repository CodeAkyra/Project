...
<body class="body-iframe-padding">
    ...
    <div class="header">
        ...
        <button class="btn-cancel" id="discardeditBtn" onclick="parent.postMessage('requestMaterial-discardAction', '*')">Discard Changes</button>
            ...
            <table class="table-material-added">
                ...
                <tbody class="td-style">
                    <tr>
                        ...
                        <td class="td-qty"><input type="number" value="0"></td>
                        <td class="td-qty-avail">500</td>
                        <td class="td-action">
                            <button class="delete-button" onclick=""><i
