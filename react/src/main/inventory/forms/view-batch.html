...
<body class="body-iframe-padding">
            ...
            <table class="table-view-records">
                ...
                <tbody class="td-style">
                    <tr>
                        ...
                        <td class="td-action"><button class="view-button" onclick="parent.postMessage('','*')"><i class="btnView fa-solid fa-eye"></i></button></td>
                        <td class="td-action"><button class="view-button" onclick="parent.postMessage('openReleasedMaterialsModal','*')"><i class="btnView fa-solid fa-eye"></i></i></button></td>
                    </tr>
                </tbody>
            </table>
        </div>
    ...
    <script>
        ...
        document.getElementById('cancelrequestBtn').addEventListener('click', function () {
            parent.postMessage('viewBatch-cancelAction', '*');
        });
    </script>

    <script>
        document.getElementById('save-create-request').addEventListener('click', function () {
            parent.postMessage('inventoryCreateReceive-saveAction', '*');
        })
    </script>
</body>
