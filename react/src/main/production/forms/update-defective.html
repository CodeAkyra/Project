...
<body class="body-iframe-padding">
    <div class="header">
        <h1 class="header-title">Request Return : Defective > Update Details</h1>
        <div class="button-container">
            <button class="btn-cancel" id="discard-Btn">Discard Changes</button>
            <button class="btn-create" id="save-update-defectiveBtn"
        ...
        <div class="blue-bar">
            ...
            <div class="form-content">
                ...
                <div class="inputs-top-row">
                    ...
                    <!-- GUSTO KO DIN SANA PARANG MERON PAG LALAGYAN NG IMAGE DITO SOMEWHERE EVERYTIME NAG UUPLOAD, YUNG PARANG KATULAD LANG DIN SA DEFECTIVE YUNG MAY TATLONG PICS, NASA LOOB SIYA NG BOX -->
                    <!-- GUSTO KO DIN SANA PARANG MERON PAG LALAGYAN NG IMAGE DITO SOMEWHERE EVERYTIME NAG UUPLOAD, YUNG PARANG KATULAD LANG DIN SA DEFECTIVE YUNG MAY TATLONG PICS, NASA LOOB SIYA NG BOX -->
                    <!-- GUSTO KO DIN SANA PARANG MERON PAG LALAGYAN NG IMAGE DITO SOMEWHERE EVERYTIME NAG UUPLOAD, YUNG PARANG KATULAD LANG DIN SA DEFECTIVE YUNG MAY TATLONG PICS, NASA LOOB SIYA NG BOX -->
                    <!-- GUSTO KO DIN SANA PARANG MERON PAG LALAGYAN NG IMAGE DITO SOMEWHERE EVERYTIME NAG UUPLOAD, YUNG PARANG KATULAD LANG DIN SA DEFECTIVE YUNG MAY TATLONG PICS, NASA LOOB SIYA NG BOX -->
                    <!-- GUSTO KO DIN SANA PARANG MERON PAG LALAGYAN NG IMAGE DITO SOMEWHERE EVERYTIME NAG UUPLOAD, YUNG PARANG KATULAD LANG DIN SA DEFECTIVE YUNG MAY TATLONG PICS, NASA LOOB SIYA NG BOX -->
                ...
                <table class="table-material-added">
                    ...
                    <tbody class="td-style">
                        <tr>
                            ...
                            <!-- palitan din class name nito to td-supplier -->
                            <td class="td-return-qty">10</td> <!-- palitan din class name nito to td-return-qty -->
                            <td class="td-images">
                                <button class="view-image"><i class="btnEdit fa-solid fa-image"></i></button>
                                <button class="reupload"><i class="btnReup fa-solid fa-rotate-right"></i></button>
                            </td>
                            <!-- YUNG BUTTON IS RE-UPLOAD YUNG ICON AND AYUN NGA, IOOVERWRITE YUNG UNANG EXISTING NA INUPLOAD -->
                            <!-- Temporary muna toh -->
                            <td class="td-action">
    ...
    <script>
        document.getElementById('save-update-defectiveBtn').addEventListener('click', function () {
