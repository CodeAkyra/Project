...
<head>
    ...
    <title>Requested Material Approved</title>
</head>
        ...
        <div class="form-content">
            ...
            <div class="inputs-top-row">
                <div class="input-grp">
                    ...
                    <span class="input-label value">PR_0001</span>
                    <input class="input reqID" type="text" value="req_0001" disabled>
                </div>
