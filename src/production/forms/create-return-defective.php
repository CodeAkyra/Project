...
<body class="body-iframe-padding">
    <div class="header">
        <h1 class="header-title">Production > Request Return > Defective</h1>
        <button class="btn-qr" id="qrBtn"><i class="fas fa-qrcode qr-font"></i></button>
        <button class="btn-cancel" id="cancelreturnBtn">Cancel</button>
        <button class="btn-create" id="save-return-defectiveBtn"
            ...
            <table class="table-material-added">
                ...
                <tbody class="td-style">
                    <tr>
                        ...
                        <td class="td-images"><button class="image-button">
                                <i class="btnImage fa-regular fa-image"></i>
                            </button></td>
                        <td class="td-action">
    ...
    <script>
        document.getElementById('save-return-defectiveBtn').addEventListener('click', function () {
...
<!-- Dito lahat ng content for Create Defective Return -->