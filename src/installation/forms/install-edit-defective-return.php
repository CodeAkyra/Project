...
<head>
    ...
    <title>Edit Defective Return</title>
...
<body class="body-iframe-padding">
    ...
    <!-- HEADER -->
    <div class="header">
        <h1 class="header-title">Production > Defective Return > Edit Defective Returns</h1>
        <button class="btn-cancel" id="cancelBtn">Discard Changes</button>
    ...
    <script>
        ...
        document.getElementById('cancelBtn').addEventListener('click', function () {
            parent.postMessage('installReturn-cancelAction', '*');
        });
    </script>
    ...
    <script>
        ...
        document.getElementById('saverequestBtn').addEventListener('click', function () {
            parent.postMessage('installCreateReturn-saveAction', '*');
        });
    </script>
