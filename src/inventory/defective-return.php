...
<body class="body-iframe-padding">
    ...
    <!-- HEADER -->
    <div class="header">
        <h1 class="header-title">Inventory > Defective Materials</h1>
    </div>
    ...
    <div class="module-content">
        ...
        <div class="blue-bar">
            <h1 class="module-title">Defective Materials</h1>
